...
from .views import account_list_view, account_detail_view, balance_view, transaction_detail_view, user_list, transaction_create_view, account_create_view#, login, sample_api
...
urlpatterns = [
    ...
    path('balance/<int:user_id>/<str:date>/', balance_view),
    # path('login/', login),
